...
"[project]/src/components/providers/CartProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CartProvider({ children }) {
            ...
            setItems({
                "CartProvider.useCallback[addToCart]": (prev)=>{
                    const existing = prev.find({
                        "CartProvider.useCallback[addToCart].existing": (item)=>item.id === product.id
                    }["CartProvider.useCallback[addToCart].existing"]);
                    if (existing) {
                        return prev.map({
                            "CartProvider.useCallback[addToCart]": (item)=>item.id === product.id ? {
                                    ...item,
    ...
    const removeFromCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[removeFromCart]": (id)=>{
            setItems({
                "CartProvider.useCallback[removeFromCart]": (prev)=>prev.filter({
                        "CartProvider.useCallback[removeFromCart]": (item)=>item.id !== id
            ...
            if (quantity <= 0) {
                setItems({
                    "CartProvider.useCallback[updateQuantity]": (prev)=>prev.filter({
                            "CartProvider.useCallback[updateQuantity]": (item)=>item.id !== id
...
_s(CartProvider, "5J1GtLJTUyRePX67657SuK0IuKQ=");
_c = CartProvider;
function useCart() {
    _s1();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__621a0659._.js.map