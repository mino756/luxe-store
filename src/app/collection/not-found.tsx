      ...
      <div className="text-center max-w-md">
        ...
        <div className="mb-6 sm:mb-8 flex justify-center">
          <div className="relative">
            <AlertCircle className="w-16 h-16 sm:w-20 sm:h-20 text-black opacity-20" />
        ...
        {/* Message */}
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">Collection Not Found</h2>
        <p className="text-sm sm:text-base text-gray-600 mb-8 sm:mb-12">
          The collection you're looking for doesn't exist. Explore other collections or return to our home page.
        </p>
        ...
        <div className="mt-12 sm:mt-16 pt-8 sm:pt-12 border-t border-gray-200">
          <p className="text-xs sm:text-sm text-gray-500 mb-4">Explore</p>
