  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center px-4 py-8">
      <div className="text-center max-w-md">
        ...
        {/* Message */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2 sm:mb-3">Something Went Wrong</h1>
        <p className="text-sm sm:text-base text-gray-600 mb-2">
          We encountered an unexpected error. Please try again or return to home.
        </p>
        
        {process.env.NODE_ENV === 'development' && error && (
          <details className="mt-4 mb-6 text-left bg-red-50 p-3 rounded-lg border border-red-200">
