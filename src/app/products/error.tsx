  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center px-4 py-8">
      <div className="text-center max-w-md">
        ...
        {/* Message */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2 sm:mb-3">Product Error</h1>
        <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">
          We had trouble loading this product. Please try again or browse our collection.
        </p>
        ...
        <div className="pt-6 sm:pt-8 border-t border-gray-200">
          <p className="text-xs sm:text-sm text-gray-500 mb-4">Still Having Issues?</p>
          <a 
